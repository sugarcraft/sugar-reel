...
final class ManagerBuilder
{
    ...
    public function build(): \SugarCraft\SuperCandy\Manager
    {
        if ($this->left === null || $this->right === null) {
            throw new \LogicException('left and right panes are required');
        }

        return new \SugarCraft\SuperCandy\Manager(
            $this->left,
            $this->right,
            $this->activeIdx,
            $this->status,
