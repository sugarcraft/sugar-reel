...
rm -f src/Grid/Chart.php src/Grid/Graph.php src/Grid/Canvas.php
rm -f src/Grid/AreaChart.php src/Grid/Area.php src/Grid/AreaPoint.php src/Grid/SparkArea.php
...
echo "Done deleting Grid chart files"