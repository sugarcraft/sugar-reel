...
final class StyleParserTest extends TestCase
{
    ...
    public function testFgColorOnly(): void
    {
        ...
        for ($i = 0; $i < 4; $i++) {
            ...
            $this->assertNotNull($cells[$i]->style->foreground);
            $this->assertSame(205, $cells[$i]->style->foreground->r);
            $this->assertSame(0, $cells[$i]->style->foreground->g);
            $this->assertSame(0, $cells[$i]->style->foreground->b);
        }
    }
    ...
    public function testBgColorOnly(): void
    {
        ...
        for ($i = 0; $i < 4; $i++) {
            $this->assertSame($expected[$i], $cells[$i]->rune);
            $this->assertNotNull($cells[$i]->style->background);
            $this->assertSame(0, $cells[$i]->style->background->r);
            $this->assertSame(0, $cells[$i]->style->background->g);
            $this->assertSame(238, $cells[$i]->style->background->b);
        }
    }
    ...
    public function testBoldModifier(): void
    {
        ...
        for ($i = 0; $i < 4; $i++) {
            $this->assertSame($expected[$i], $cells[$i]->rune);
            $this->assertTrue($cells[$i]->style->bold);
        }
    }
    ...
    public function testItalicModifier(): void
    {
        ...
        for ($i = 0; $i < 4; $i++) {
            $this->assertSame($expected[$i], $cells[$i]->rune);
            $this->assertTrue($cells[$i]->style->italic);
        }
    }
    ...
    public function testUnderlineModifier(): void
    {
        ...
        for ($i = 0; $i < 4; $i++) {
            $this->assertSame($expected[$i], $cells[$i]->rune);
            $this->assertTrue($cells[$i]->style->underline);
        }
    }
    ...
    public function testDimModifier(): void
    {
        ...
        for ($i = 0; $i < 4; $i++) {
            $this->assertSame($expected[$i], $cells[$i]->rune);
            $this->assertTrue($cells[$i]->style->dim);
        }
    }
    ...
    public function testReverseModifier(): void
    {
        ...
        for ($i = 0; $i < 4; $i++) {
            $this->assertSame($expected[$i], $cells[$i]->rune);
            $this->assertTrue($cells[$i]->style->reverse);
        }
    }
    ...
    public function testStrikeModifier(): void
    {
        ...
        for ($i = 0; $i < 4; $i++) {
            $this->assertSame($expected[$i], $cells[$i]->rune);
            $this->assertTrue($cells[$i]->style->strike);
        }
    }
    ...
    public function testNamedColors(): void
    {
        ...
        foreach ($colors as $name => [$er, $eg, $eb]) {
            ...
            $this->assertSame($er, $cells[0]->style->foreground->r, "Failed for color: {$name}");
            $this->assertSame($eg, $cells[0]->style->foreground->g, "Failed for color: {$name}");
            $this->assertSame($eb, $cells[0]->style->foreground->b, "Failed for color: {$name}");
        }
    }
    ...
    public function testBrightColors(): void
    {
        ...
        foreach ($colors as $name => [$er, $eg, $eb]) {
            ...
            $this->assertSame($er, $cells[0]->style->foreground->r, "Failed for bright color: {$name}");
            $this->assertSame($eg, $cells[0]->style->foreground->g, "Failed for bright color: {$name}");
            $this->assertSame($eb, $cells[0]->style->foreground->b, "Failed for bright color: {$name}");
        }
    }
    ...
    public function testHex3Color(): void
    {
        ...
        $this->assertSame(255, $cells[0]->style->foreground->r);
        $this->assertSame(0, $cells[0]->style->foreground->g);
        $this->assertSame(0, $cells[0]->style->foreground->b);
    }
    ...
    public function testHex6ColorGreen(): void
    {
        ...
        $this->assertCount(1, $cells);
        $this->assertSame(0, $cells[0]->style->foreground->r);
        $this->assertSame(255, $cells[0]->style->foreground->g);
        $this->assertSame(0, $cells[0]->style->foreground->b);
    }
    ...
    public function testHex6ColorBlue(): void
    {
        ...
        $this->assertSame(0, $cells[0]->style->foreground->r);
        $this->assertSame(0, $cells[0]->style->foreground->g);
        $this->assertSame(255, $cells[0]->style->foreground->b);
    }
    ...
    public function testUnknownColorIgnored(): void
    {
        ...
        for ($i = 0; $i < 4; $i++) {
            ...
            $this->assertNull($cells[$i]->style->foreground);
        }
    }
    ...
    public function testUnknownForegroundWithValidBackground(): void
    {
        ...
        $this->assertCount(1, $cells);
        $this->assertNull($cells[0]->style->foreground);
        $this->assertNotNull($cells[0]->style->background);
        $this->assertSame(205, $cells[0]->style->background->r);
    }
    ...
    public function testExtraOpenBracket(): void
    {
        ...
        // The [[text part: first [ triggers escape, then [text gets style fg:red, then ] closes
        // The remaining )fg:red is plain text
    ...
    public function testMismatchedParentheses(): void
    {
        ...
        $this->assertCount(4, $cells);
        $this->assertSame(205, $cells[0]->style->foreground->r);
    }
    ...
    public function testNestedBrackets(): void
    {
        ...
        // First cell '[' has default style
        // Then 'outer' has blue style (from outer brackets)
        // The inner ] closes the inner style, pop back
        $this->assertGreaterThanOrEqual(1, count($cells));
    }
    ...
    public function testNestedAndPlainText(): void
    {
        ...
        // 'plain ' (6 chars) with default style, then 'styled' with red, then ' more' (5 chars) default
        $this->assertGreaterThanOrEqual(1, count($cells));
    }
    ...
    public function testLongerText(): void
    {
        ...
        for ($i = 0; $i < 11; $i++) {
            $this->assertSame($expected[$i], $cells[$i]->rune);
            $this->assertSame(0, $cells[$i]->style->foreground->r);
            $this->assertSame(205, $cells[$i]->style->foreground->g);
            $this->assertSame(0, $cells[$i]->style->foreground->b);
        }
    }
    ...
    public function testStyledTextBetweenPlainText(): void
    {
        ...
        for ($i = 7; $i < 13; $i++) {
            $this->assertSame(0, $cells[$i]->style->foreground->r);
            $this->assertSame(0, $cells[$i]->style->foreground->g);
            $this->assertSame(238, $cells[$i]->style->foreground->b);
        }
    ...
    public function testStyleInheritanceFromDefault(): void
    {
        ...
        $defaultWithBg = new Style(background: Color::rgb(100, 100, 100));
    ...
    public function testStylePopAfterClosingBracket(): void
    {
        ...
        $defaultFg = new Style(foreground: Color::rgb(100, 100, 100));
        ...
        $this->assertSame(205, $cells[0]->style->foreground->r); // 'x'
        $this->assertSame(100, $cells[1]->style->foreground->r); // 'p'
    }
    ...
    public function testSingleCharacterStyled(): void
    {
        ...
        $this->assertCount(1, $cells);
        $this->assertSame('x', $cells[0]->rune);
        $this->assertTrue($cells[0]->style->bold);
    }
    ...
    public function testSpecialCharacters(): void
    {
        ...
        $this->assertCount(5, $cells);
        foreach ($cells as $cell) {
            $this->assertSame(205, $cell->style->foreground->r);
            $this->assertSame(205, $cell->style->foreground->g);
            $this->assertSame(0, $cell->style->foreground->b);
        }
    }
    ...
    public function testBackgroundAlias(): void
    {
        ...
        $this->assertCount(1, $cells);
        $this->assertSame(0, $cells[0]->style->background->r);
        $this->assertSame(0, $cells[0]->style->background->g);
        $this->assertSame(238, $cells[0]->style->background->b);
    }
    ...
    public function testModifierCaseSensitivity(): void
    {
        ...
        $this->assertCount(1, $cells);
        $this->assertTrue($cells[0]->style->bold);
        $this->assertTrue($cells[0]->style->italic);
    }
}
