 ...
 */
final class Log implements \SugarCraft\Dash\Foundation\Sizer
{
    ...
    {
        $clone = clone $this;
        $clone->originalEntries = array_merge($clone->originalEntries, [$entry]);
        $clone->entries = $this->filterAndSortEntries($clone->originalEntries);
        return $clone;
    }
