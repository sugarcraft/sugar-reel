...
final class Drawer implements \SugarCraft\Dash\Foundation\Sizer
{
     ...
     */
    public static function new(\SugarCraft\Dash\Foundation\Item|string $content, string $position = self::POSITION_LEFT): self
    {
        return new self(
            content: $content,
            position: $position,
     ...
     */
    public static function left(\SugarCraft\Dash\Foundation\Item|string $content): self
    {
     ...
     */
    public static function right(\SugarCraft\Dash\Foundation\Item|string $content): self
    {
     ...
     */
    public static function top(\SugarCraft\Dash\Foundation\Item|string $content): self
    {
     ...
     */
    public static function bottom(\SugarCraft\Dash\Foundation\Item|string $content): self
    {
