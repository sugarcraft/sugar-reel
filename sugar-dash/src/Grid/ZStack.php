 ...
 */
final class ZStack implements Sizer
{
     ...
     */
    public static function new(Item ...$items): self
    {
        return new self(
            items: $items,
     ...
     */
    public static function left(Item ...$items): self
    {
        return new self(
            items: $items,
     ...
     */
    public static function right(Item ...$items): self
    {
        return new self(
            items: $items,
     ...
     */
    public static function top(Item ...$items): self
    {
        return new self(
            items: $items,
            alignment: HAlign::Center,
     ...
     */
    public static function bottom(Item ...$items): self
    {
        return new self(
            items: $items,
            alignment: HAlign::Center,
     ...
     */
    public function withTop(Item $item): self
    {
        return new self(
     ...
     */
    public function withBottom(Item $item): self
    {
        return new self(
