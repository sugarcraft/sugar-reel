 ...
 */
final class VStack implements Sizer
{
     ...
     */
    public static function spaced(int $spacing, Item ...$items): self
    {
        return new self(
            items: $items,
     ...
     */
    public static function centered(Item ...$items): self
    {
        return new self(
            items: $items,
            spacing: 0,
     ...
     */
    public function withAppended(Item $item): self
    {
        return new self(
     ...
     */
    public function withPrepended(Item $item): self
    {
        return new self(
