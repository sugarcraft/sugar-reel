...
final class TuiComponentTest extends TestCase
{
    ...
    {
        $panes = [
            Pane::Chat => fn() => ChatPane::render($this->makeApp(Pane::Chat), 120, 40),
            Pane::Input => fn() => InputPane::render($this->makeApp(Pane::Input), 120),
            Pane::Skills => fn() => SkillsPane::render($this->makeApp(Pane::Skills), 40, 20),
            Pane::Agents => fn() => AgentsPane::render($this->makeApp(Pane::Agents), 40, 20),
            Pane::Files => fn() => FilesPane::render($this->makeApp(Pane::Files), 40, 20),
            Pane::Tools => fn() => ToolsPane::render($this->makeApp(Pane::Tools), 40, 20),
            Pane::Settings => fn() => ChatPane::render($this->makeApp(Pane::Settings), 120, 40),
            Pane::Help => fn() => ChatPane::render($this->makeApp(Pane::Help), 120, 40),
        ];
