...
final class OpenAIProviderTest extends TestCase
{
    ...
    public function testCompleteReturnsCompleteResponse(): void
    {
        ...
        $chatMock = $this->createMock(\OpenAI\Resources\Chat::class);
        ...
        $completionResponse->method('toArray')->willReturn([
            'choices' => [
                [
                    'message' => [
    ...
    public function testEmbeddingsReturnsCorrectStructure(): void
    {
        ...
        $embeddingsMock = $this->createMock(\OpenAI\Resources\Embeddings::class);
        $client->method('embeddings')->willReturn($embeddingsMock);

        // Mock the response object
        $responseMock = $this->createMock(\OpenAI\Responses\Embeddings\EmbeddingsResponse::class);
