...
## Goal
Create the fluent AppBuilder class.

## What To Do

Create `src/App/AppBuilder.php`:
...
- `candy-crush/src/App/AppBuilder.php`

## Verification
- Builder is mutable (for fluent chaining)
- build() returns immutable App
- All with*() methods clone and return $this
- PSR-12 compliant
