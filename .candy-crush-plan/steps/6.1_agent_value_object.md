...
## Goal
Create Agent value object.

## What To Do

### Agent.php
Create `src/Agents/Agent.php`:
...
### AgentDefinition.php
Create `src/Agents/AgentDefinition.php`:
...
## Files To Create
- `candy-crush/src/Agents/Agent.php`
- `candy-crush/src/Agents/AgentDefinition.php`

## Verification
- Agent is immutable (readonly)
- AgentDefinition provides built-in types
- Proper toArray/fromArray for serialization
