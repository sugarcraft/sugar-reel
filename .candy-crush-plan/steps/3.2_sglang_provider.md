...
## Goal
Implement the SGLANG provider for OpenAI-compatible endpoints (MiniMax-M2.7).

## What To Do

Create `src/Providers/SglangProvider.php`:
...
final readonly class SglangProvider implements ProviderInterface
{
    ...
    public function name(): string => 'sglang';
    ...
    public function contextWindow(): int => 128_000;  // Varies by model
...
## Files To Create
- `candy-crush/src/Providers/SglangProvider.php`
